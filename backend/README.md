...
## Project Structure
    ...
    ├── ideapros_lyrassist_35852  # Django project configurations
...
1. Clone this repo and `cd ideapros_lyrassist_35852`
...
2. Clone this repo and `cd ideapros_lyrassist_35852`
